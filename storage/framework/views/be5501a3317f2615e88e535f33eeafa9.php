    ...
    <div class="container p-5">
        <div class="profile card p-5 text-center">
            ...
            <div class="text-center">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="BracU LOGO">
            </div>
    
            <h3 class="text-center my-5 text-uppercase">Welcome to BracU Office Management Syatem</h3>
...
<?php /**PATH /storage/ssd1/586/22052586/public_html/resources/views/index.blade.php ENDPATH**/ ?>