...
<head>
    ...
    <title>Registration-BracU Office Management Syatem</title>
...
<body>
    <div class="login-dark" style="height: 695px;">
        <form method="POST" action="<?php echo e(route('registration.submit')); ?>">
            <?php echo csrf_field(); ?>
            <h2 class="sr-only">Registration Form</h2>
            <div class="illustration">
                <img style="max-width: 150px;" src="<?php echo e(asset('images/logo.png')); ?>" alt="BracU LOGO">
            </div>
            ...
            <p class="muted">Bracu Office Management</p>
        </form>
...
</html><?php /**PATH /storage/ssd1/586/22052586/public_html/Main/resources/views/auth/registration.blade.php ENDPATH**/ ?>